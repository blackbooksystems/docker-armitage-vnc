...
RUN curl -O http://tigervnc.sourceforge.net/tiger.nightly/ubuntu-14.04LTS/amd64/tigervncserver_1.4.80+20150430git8eacfb83-3ubuntu1_amd64.deb && \
...
RUN mkdir /root/.vnc /root/Desktop && \
	...
	chmod +x /usr/bin/startx /root/.vnc/xstartup /etc/service/vncserver/run /etc/service/postgresql/run
